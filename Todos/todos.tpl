...
{if $showDone && $todos_finished|@count > 0}
   <form method="post"onsubmit="return confirm('Nach deiner Bestätigung werden alle deine erledigten ToDos gelöscht.');" class="mb-4">
    <input type="hidden" name="delete_done" value="1">
