...
<div class="container my-5">
  ...
  <section class="mb-5">
    <h2>7. Datenschutz</h2>
    <p>Details zur Verarbeitung Ihrer personenbezogenen Daten entnehmen Sie bitte unserer <a href="privacy.html">Datenschutzerklärung</a>.</p>
  </section>
