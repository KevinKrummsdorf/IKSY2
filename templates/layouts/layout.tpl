...
<header class="site-header d-flex justify-content-between align-items-center px-4 py-2">
  ...
  <nav class="header-auth-links">
    {if $isLoggedIn}
      ...
      <a href="{$base_url}/logout{$url_suffix}" class="btn btn-sm btn-outline-secondary">Logout</a>
    {else}
...
<div class="menu d-none d-md-block">
  <ul class="menu-content mt-4">
    <li><a href="{$base_url}/profile/my{$url_suffix}"><span class="material-symbols-outlined">account_circle</span><span>Mein Profil</span></a></li>
    <li><a href="{$base_url}/search_profile{$url_suffix}"><span class="material-symbols-outlined">person_search</span><span>Andere Mitglieder finden</span></a></li>
    <li><a href="{$base_url}/my_groups{$url_suffix}"><span class="material-symbols-outlined">group</span><span>Meine Lerngruppen</span></a></li>
    <li><a href="{$base_url}/groups{$url_suffix}"><span class="material-symbols-outlined">groups</span><span>Alle Lerngruppen</span></a></li>
    <li><a href="{$base_url}/todos{$url_suffix}"><span class="material-symbols-outlined">checklist</span><span>To Do's</span></a></li>
    <li><a href="{$base_url}/browse{$url_suffix}"><span class="material-symbols-outlined">search</span><span>Material finden</span></a></li>
    <li><a href="{$base_url}/upload{$url_suffix}"><span class="material-symbols-outlined">arrow_circle_up</span><span>Material hochladen</span></a></li>
    <li><a href="{$base_url}/my_uploads{$url_suffix}"><span class="material-symbols-outlined">folder</span><span>Meine Uploads</span></a></li>
    <li><a href="{$base_url}/timetable{$url_suffix}"><span class="material-symbols-outlined">calendar_month</span><span>Stundenplan</span></a></li>
...
<footer class="text-center mt-4 py-3">
  <div class="container-fluid">
    <a href="{$base_url}/about{$url_suffix}" class="mx-2">Über uns</a> |
    <a href="{$base_url}/privacy{$url_suffix}" class="mx-2">Datenschutz</a> |
    <a href="{$base_url}/terms{$url_suffix}" class="mx-2">AGB</a> |
    <a href="{$base_url}/contact{$url_suffix}" class="mx-2">Kontakt</a> |
    <a href="{$base_url}/impressum{$url_suffix}" class="mx-2">Impressum</a>
