...
<div class="container mt-5">
  ...
  <!-- Filterformular -->
  <form class="row g-3 mt-3 mb-4" method="get" action="{$base_url}/locked_users{$url_suffix}">
    <div class="col-md-3">
    ...
    <div class="col-12 d-flex justify-content-end">
      ...
      <a href="{$base_url}/locked_users{$url_suffix}" class="btn btn-outline-secondary me-2">Zurücksetzen</a>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <form method="post" action="{$base_url}/locked_users{$url_suffix}" onsubmit="return confirm('Benutzer wirklich entsperren?');">
