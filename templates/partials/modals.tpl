  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id="loginAlert" class="mt-2"></div> {* <- für Fehlermeldungen *}
        <form action="login.php" method="POST">
  <div id="loginAlert" class="mt-2"></div>

  <div class="mb-3 position-relative">
    <input type="text" id="username_or_email" name="username_or_email" class="form-control" placeholder="Username oder E-Mail" required>
    <i class="bx bxs-user position-absolute top-50 end-0 translate-middle-y pe-3"></i>
  </div>

  <div class="mb-3 position-relative">
    <input type="password" id="loginPassword" name="password" class="form-control" placeholder="Passwort" required>
