...
<div class="container mt-5">
  ...
  <form class="row g-3 mb-4" method="get" action="{$base_url}/pending_courses{$url_suffix}">
    <div class="col-md-3">
    ...
    <div class="col-12 d-flex justify-content-end">
      ...
      <a href="{$base_url}/pending_courses{$url_suffix}" class="btn btn-outline-secondary me-2">Zurücksetzen</a>
          ...
          <table class="table table-bordered align-middle">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <form method="post" action="{$base_url}/pending_courses{$url_suffix}" class="d-flex flex-column align-items-start">
