...
<div class="container mt-5">
  ...
  <!-- Filterformular -->
  <form class="row g-3 mt-3 mb-4" method="get" action="{$base_url}/upload_logs{$url_suffix}">
    <div class="col-md-2">
    ...
    <div class="col-12 d-flex justify-content-end">
      ...
      <a href="{$base_url}/upload_logs{$url_suffix}" class="btn btn-outline-secondary me-2">Zurücksetzen</a>
